...
package com.by.jetnews.ui.components
...
import com.by.jetnews.ui.JetnewsDestinations
import com.by.jetnews.ui.theme.JetnewsTheme

/**
 * {@code @description} 应用程序导航栏
 * @param currentRoute 当前路由
 * @param navigateToHome 导航到主页
 * @param navigateToInterests 导航到兴趣
 * @param modifier 修饰符
 * @sample com.by.jetnews.ui.components.PreviewAppNavRail
 */
@Composable
fun AppNavRail(
    currentRoute: String,
